...
<jsp:include page="/WEB-INF/views/fragments/header.jsp">
    <jsp:param name="title" value="Stock Adjustment - SmartInventory" />
</jsp:include>
...
<main class="main-content">
    <jsp:include page="/WEB-INF/views/fragments/topbar.jsp">
        <jsp:param name="pageTitle" value="Stock Adjustment" />
    </jsp:include>
    ...
    <div style="display: flex; justify-content: flex-end; gap: 0.5rem; margin-bottom: 1.25rem;">
        ...
        <div class="card">
        <form action="${pageContext.request.contextPath}/inventory/adjust" method="post" data-validate>
        ...
        <option value="${product.productId}">${product.sku} - ${product.productName} (Current: ${product.stockQuantity})</option>
        </c:forEach>
        </select>
        </div>
        <div class="form-group">
        <label for="newQuantity">New Quantity <span style="color: red;">*</span></label>
        <input type="number" id="newQuantity" name="newQuantity" class="form-control" min="0" required>
        <small style="color: #6c757d;">This will set the stock to the exact value specified</small>
        </div>
        <div class="form-group">
        ...
        <textarea id="notes" name="notes" class="form-control" rows="3" placeholder="Reason for adjustment..."></textarea>
        </div>
        <div class="btn-group">
